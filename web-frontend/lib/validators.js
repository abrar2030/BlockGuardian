// Client-side validation mirroring code/backend/src/security/validation.py
// Keeping these in sync avoids round-tripping obviously invalid input to the API.
